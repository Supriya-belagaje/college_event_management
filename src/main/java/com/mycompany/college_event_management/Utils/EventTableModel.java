...
public class EventTableModel extends AbstractTableModel {
    ...
    private final String[] columnNames = {"Event ID", "Event Name", "Venue Id", "Organizer ID", "Event Date", "Description"};
    ...
    public void setRowCount(int i) {
         events.clear(); // Clear the existing data
    fireTableRowsDeleted(0, events.size() - 1);
    }
